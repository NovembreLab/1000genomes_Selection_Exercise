...
cd ~/data
../bin/bcftools view -v snps -m 2 -M 2 -O z 1000genomes_phase3_chr2_108013601_111013601.vcf.gz > snv_1000genomes_chr2_108013601_111013601.vcf.gz
```
...
cd ~/data
../bin/plink-1.9 --vcf snv_1000genomes_$tag.vcf.gz \
...
../bin/bcftools view snv_1000genomes_$tag.vcf.gz --exclude 'ID=@tmp.exclude.txt' -O z > snv_1000genomes_${tag}_HWEfiltered.vcf.gz
...
tag=chr2_108013601_111013601
cd ~/data
../bin/plink-1.9 --vcf snv_1000genomes_${tag}_HWEfiltered.vcf.gz \
          --fst \
          --within 1kgv3_clst.txt \
...
Make sure your working directory in R is set to the data subdirectory.  (Use the "Session" tab or setwd() command to change your working directory, e.g. setwd("~/git/1000genomes_Selection_Exercise/data")).
...
../bin/bcftools view -S CHB_iids.txt \
         -q '.05 minor' \
         -O z \
...
../bin/bcftools view CHB_${tag}_HWEfiltered.vcf.gz \
...
../bin/plink-1.9 --bim CHB_${tag}_HWEfiltered.bim \
...
This command will take about 5 minutes.
