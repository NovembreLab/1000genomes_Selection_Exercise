...
awk  '($3 == "YRI" || $3 == "CEU") {print $0}' yri_ceu_chb_clst.txt > yri_ceu_clst.txt

# write a clst file for just YRI and CHB 
awk '{($3 == "YRI" || $3 == "CHB") print $0}' yri_ceu_chb_clst.txt > yri_chb_clst.txt
...
bcftools view -V indels -m 2 -M 2 -S yri_ceu_chb_iids.txt -O z -q '.1 minor' 1000genomes_phase3_chr1_158000000_162000000.vcf.gz > yri_ceu_chb_chr1_158000000_162000000_filtered.vcf.gz

# keep YRI individuals from the filtered vcf
# this will be used for haplotype based selection analysis.
bcftools view -S yri_iids.txt -O z yri_ceu_chb_chr1_158000000_162000000_filtered.vcf.gz > yri_chr1_158000000_162000000_filtered.vcf.gz
