...
```
For a full explanation of the population codes, see: (http://ftp.1000genomes.ebi.ac.uk/vol1/ftp/README.populations)
...
Now, let's download a 3Mb part of the the 1000 Genomes Phase 3 project data to use. 
...
In another terminal window or screen open an R session that we will be using for the rest of the workshop. Now run these commands in the R session.
...
#### Add code to make plots of pairwise Fst for FIN vs CHB and narrative to say how we see pairwise fst values high but which population is it occuring in?  Motivate computation of PBS

#### Questions

1.  Suppose the 99.9th percentile of $F_{ST}$ between CHB and FIN genome-widew as 0.1.  Do you see any variants in this 3Mb region that are among the most differentiated in the genome?  
